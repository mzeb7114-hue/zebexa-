...
let isLogin = false; // CHANGED: Start with SIGN UP mode

// Initial text - CHANGED: Start with sign up mode
  ...
  try {
    ...
    if (error) {
      ...
      if (isLogin) {
        ...
        // FIXED: Reduced delay from 800ms to 200ms
        setTimeout(() => {
          window.location.href = "orientation.html";
        }, 200);
      } else {
        // FIXED: Sign up now redirects to orientation immediately
